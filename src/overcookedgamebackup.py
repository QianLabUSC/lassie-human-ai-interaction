...
class OvercookedUI:
    ...
    def init_ui(self, user_mode, input_box_width, input_box_height, pause_button_width, pause_button_height, conversation_box_width, manager, screen):
        ...
        self.text_entry_box = pygame_gui.elements.UITextEntryBox(
        ...
        self.submit_button = pygame_gui.elements.UIButton(
            relative_rect=pygame.Rect((input_box_width + 10, self.screen_height - input_box_height), (100, 40)),
            text='Submit',
            manager=self.manager
        )
    ...
    def submit_text_entry(self):
        text = self.text_entry_box.get_text()
        self.append_response(text, 'human')
        print("Submitted Text:", text)
        self.status_label.set_text("Agent responding...")
        self.text_entry_box.set_text('') 
        ...
        while self._running:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame_gui.UI_BUTTON_PRESSED:
                    ...
                    if event.ui_element == self.ui.submit_button:
                        self.ui.submit_text_entry()
                        user_text = self.ui.text_entry_box.get_text()
                        self.agent2.dm.receive_message(user_text)
